  ...
  return (
    <section className='py-16 px-4 lg:px-0'>
        <div className="container mx-auto text-center mb-10 relative">
            ...
            <p className='text-lg text-gray-600 mb-8'>Discover the latest additions to our collection, carefully curated just for you. fashion forward and trendsetting pieces that will elevate your style.</p>
